...
import (
	...
	"github.com/alitto/pond/unboundedchanv3"
)
...
type workerPool struct {
	...
	dispatcher      *unboundedchanv3.UnboundedChan[func()]
}
...
func (p *workerPool) dispatch(incomingTasks []func()) {
...
func NewPool(ctx context.Context, maxWorkers int) WorkerPool {
	...
	pool.dispatcher = unboundedchanv3.NewUnboundedChan[func()](ctx, pool.dispatch, int(tasksLen))
